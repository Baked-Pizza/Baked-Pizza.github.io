...
contract DollarBeans is Context, Ownable {
    ...
    address public DEV_ADDRESS = 0x2bFCf79Da39F31ac1d4d1C4c840c68950BA7E692;
    address public MARKETING_ADDRESS = 0x2bFCf79Da39F31ac1d4d1C4c840c68950BA7E692;
    address public CEO_ADDRESS = 0x2bFCf79Da39F31ac1d4d1C4c840c68950BA7E692;
    address public GIVEAWAY_ADDRESS = 0x2bFCf79Da39F31ac1d4d1C4c840c68950BA7E692;
    ...
    uint256 MIN_DEPOSIT = 2 ether; // 10 BUSD
    uint256 MIN_BAKE = 0.1 ether; // 1 BUSD
    ...
    function buyBeans(address ref, uint256 _amount) public {
        ...
        IERC20(BNB).transferFrom(msg.sender, address(this), _amount);
    ...
    function sendFees(uint256 totalFee, uint256 giveAway) private {
        ...
        IERC20(BNB).transfer(_dev, dev);
        IERC20(BNB).transfer(_marketing, marketing);
        IERC20(BNB).transfer(_ceo, ceo);

        if (giveAway > 0) {
            IERC20(BNB).transfer(_giveAway, giveAway);
        }
    }
    ...
    function eat() public {
        ...
        IERC20(BNB).transfer(msg.sender, bnbToEat);
    ...
    function contractBalance() public view returns (uint256) {
        return IERC20(BNB).balanceOf(address(this));
    }
